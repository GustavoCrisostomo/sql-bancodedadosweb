...
--function: qauntidade de produtos por farmácia
DELIMITER $$
...
SELECT qtd_produtos_farmacia('12345678000199') AS total_em_estoque
 ...
 -- Trigger: impedir quantiodade negativa (BEFORE INSERT)
...
-- testando o código acima
SELECT * FROM vm_farmcia_produto;

-- View: farmácia + farmacêutico
CREATE OR REPLACE VIEW vw_farmaceutico_farmacia AS
SELECT
    fa.nomefarmacia,
    fa.cidade,
    fm.nomefarmaceutico
